...
import TopVacinasChart from "@/components/dashboard/TopVacinasChart";
import SazonalidadeChart from "@/components/dashboard/SazonalidadeChart";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch lg:auto-rows-fr">
          <div className="h-full [&>*]:h-full [&>*>*]:h-full">
            <TimeseriesChart data={timeseriesData} loading={loadingTimeseries} isMonthlyView={Boolean(ano)} />
          </div>
          <div className="h-full [&>*]:h-full [&>*>*]:h-full">
            <BrazilMap data={rankingData} loading={loadingRanking} selectedUF={uf || null} />
          </div>
          <div className="col-span-full h-full [&>*]:h-full [&>*>*]:h-full">
            <TopVacinasChart />
          </div>
        </div>
